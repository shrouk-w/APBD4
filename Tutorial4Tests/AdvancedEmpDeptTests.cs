...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(a=>a.DeptNo==30).Min(e => e.Sal);
    ...
    public void ShouldReturnDistinctJobTitles()
    {
        ...
        var jobs = emps.Select(a=>a.Job).Distinct().ToList(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(a=>a.Mgr!=null).ToList(); 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        var result = !emps.Where(a=>a.Sal<=500).ToList().Any(); 
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = emps.Where(a=>a.Comm>400).Any(); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps
            .Join(emps,
                emp => emp.Mgr,
                mgr => mgr.EmpNo,
                (emp, mgr) => new { Manager = mgr.EName, Employee = emp.EName })
            .ToList();
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(a=>new{EName = a.EName, Total = a.Sal+(a.Comm ?? 0)}).ToList(); 
